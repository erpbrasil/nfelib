...
#
# Generated Tue Feb 11 16:34:41 2020 by generateDS.py version 2.30.15.
...
#   ('-f', '')
#   ('-o', '/home/kmee/kmee/product/dfe/nfelib/nfelib/v4_00/resNFe_v1.01.py')
#
# Command line arguments:
#   /home/kmee/kmee/product/dfe/nfelib/process_includes/resNFe_v1.01.xsd
#
# Command line:
#   /home/kmee/kmee/product/dfe/erpbrasil.edoc.gen/src/erpbrasil/edoc/gen/generate_python.py --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "/home/kmee/kmee/product/dfe/nfelib/nfelib/v4_00/resNFe_v1.01.py" /home/kmee/kmee/product/dfe/nfelib/process_includes/resNFe_v1.01.xsd
#
...
class resNFe(GeneratedsSuper):
    """Schema da estrutura XML gerada pelo Ambiente Nacional com o conjunto de
    informações resumidas de uma NF-e"""
    subclass = None
    superclass = None
    def __init__(self, versao=None, chNFe=None, CNPJ=None, CPF=None, xNome=None, IE=None, dhEmi=None, tpNF=None, vNF=None, digVal=None, dhRecbto=None, nProt=None, cSitNFe=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, resNFe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if resNFe.subclass:
            return resNFe.subclass(*args_, **kwargs_)
        else:
            return resNFe(*args_, **kwargs_)
    ...
    def validate_TVerResNFe(self, value):
        # Validate type TVerResNFe, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['1.01']
            enumeration_respectee = False
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TVerResNFe' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            self.cSitNFe is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='resNFe', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('resNFe')
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='resNFe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='resNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='resNFe'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='resNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            self.validate_TVerResNFe(self.versao)    # validate type TVerResNFe
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from resNFe_v1.01 import *\n\n')
        sys.stdout.write('import resNFe_v1.01 as model_\n\n')
