...
#   ('-f', '')
#   ('-o', '/home/kmee/kmee/product/dfe/nfelib/nfelib/v4_00/e210220_v1.00.py')
#
# Command line arguments:
#   /home/kmee/kmee/product/dfe/nfelib/process_includes/e210220_v1.00.xsd
#
# Command line:
#   /home/kmee/kmee/product/dfe/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "/home/kmee/kmee/product/dfe/nfelib/nfelib/v4_00/e210220_v1.00.py" /home/kmee/kmee/product/dfe/nfelib/process_includes/e210220_v1.00.xsd
#
...
class detEvento(GeneratedsSuper):
    ...
    def validate_descEventoType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['Desconhecimento da Operacao']
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='detEvento', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='detEvento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='detEvento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='detEvento'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='detEvento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from e210220_v1.00 import *\n\n')
        sys.stdout.write('import e210220_v1.00 as model_\n\n')
