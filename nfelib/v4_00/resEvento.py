...
#
# Generated Tue Feb 11 16:34:40 2020 by generateDS.py version 2.30.15.
...
#   ('-f', '')
#   ('-o', '/home/kmee/kmee/product/dfe/nfelib/nfelib/v4_00/resEvento_v1.01.py')
#
# Command line arguments:
#   /home/kmee/kmee/product/dfe/nfelib/process_includes/resEvento_v1.01.xsd
#
# Command line:
#   /home/kmee/kmee/product/dfe/erpbrasil.edoc.gen/src/erpbrasil/edoc/gen/generate_python.py --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "/home/kmee/kmee/product/dfe/nfelib/nfelib/v4_00/resEvento_v1.01.py" /home/kmee/kmee/product/dfe/nfelib/process_includes/resEvento_v1.01.xsd
#
...
class TVerResEvento(object):
    _1_01='1.01'


class resEvento(GeneratedsSuper):
    """Schema da estrutura XML gerada pelo Ambiente Nacional com o conjunto de
    informações resumidas de um evento de NF-e"""
    subclass = None
    superclass = None
    def __init__(self, versao=None, cOrgao=None, CNPJ=None, CPF=None, chNFe=None, dhEvento=None, tpEvento=None, nSeqEvento=None, xEvento=None, dhRecbto=None, nProt=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, resEvento)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if resEvento.subclass:
            return resEvento.subclass(*args_, **kwargs_)
        else:
            return resEvento(*args_, **kwargs_)
    ...
    def validate_TVerResEvento(self, value):
        # Validate type TVerResEvento, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['1.01']
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on TVerResEvento' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='resEvento', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('resEvento')
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='resEvento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='resEvento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='resEvento'):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='resEvento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            self.validate_TVerResEvento(self.versao)    # validate type TVerResEvento
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from resEvento_v1.01 import *\n\n')
        sys.stdout.write('import resEvento_v1.01 as model_\n\n')
