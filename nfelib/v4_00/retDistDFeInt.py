...
#   ('-f', '')
#   ('-o', '/home/kmee/kmee/product/dfe/nfelib/nfelib/v4_00/retDistDFeInt_v1.01.py')
#
# Command line arguments:
#   /home/kmee/kmee/product/dfe/nfelib/process_includes/retDistDFeInt_v1.01.xsd
#
# Command line:
#   /home/kmee/kmee/product/dfe/erpbrasil.edoc.gen/src/erpbrasil/edoc/gen/generate_python.py --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "/home/kmee/kmee/product/dfe/nfelib/nfelib/v4_00/retDistDFeInt_v1.01.py" /home/kmee/kmee/product/dfe/nfelib/process_includes/retDistDFeInt_v1.01.xsd
#
...
class retDistDFeInt(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, versao=None, tpAmb=None, verAplic=None, cStat=None, xMotivo=None, dhResp=None, ultNSU=None, maxNSU=None, loteDistDFeInt=None, **kwargs_):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpAmb':
            ...
            dhResp_ = child_.text
            dhResp_ = self.gds_validate_string(dhResp_, node, 'dhResp')
            self.dhResp = dhResp_
            ...
            maxNSU_ = child_.text
            maxNSU_ = self.gds_validate_string(maxNSU_, node, 'maxNSU')
            self.maxNSU = maxNSU_
...
class loteDistDFeIntType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, docZip=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        if docZip is None:
            self.docZip = []
...
class docZipType(GeneratedsSuper):
    ...
    fiscalIdentificação do Schema XML que será utilizado para validar o
    XML existente no conteúdo da tag docZip. Vai identificar o tipo do
    documento e sua versão. Exemplos: resNFe_v1.00.xsd,
    procNFe_v3.10.xsd, resEvento_1.00.xsd, procEventoNFe_v1.00.xsd"""
    subclass = None
    superclass = None
    def __init__(self, NSU=None, schema=None, valueOf_=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from retDistDFeInt_v1.01 import *\n\n')
        sys.stdout.write('import retDistDFeInt_v1.01 as model_\n\n')
